...
namespace Amv.OsmGeo.HttpDataLayer
{
    ...
    public class ThreadSafeDictionary<TKey, TValue> : IThreadSafeDictionary<TKey, TValue>
    {
        ...
        /*public virtual TValue IndexOf(int index) {
            using (new ReadOnlyLock(dictionaryLock)) {
                return dict.ElementAt<TValue>(index);
            }
        }*/
        /// <summary>
        /// Gets the keys.
        ...
        public virtual IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator() {
            ...
            throw new NotSupportedException("Енумератор для потокобезопсного словаря не поддерживается");
        }
